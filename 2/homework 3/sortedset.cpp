...
{
    if (compareLists(newList, currentNode->value) == -1)
    {
...
SortedSet::TreeNode** SortedSet::search(SortedSet::TreeNode* &currentNode, LinkedList* list)
{
    if (currentNode == nullptr)
        return nullptr;
    if (compareLists(list, currentNode->value) == 0)
        return &currentNode;
    if (compareLists(list, currentNode->value) == -1)
...
void SortedSet::removeTreeNode(SortedSet::TreeNode* &currentNode, LinkedList* list)
{
    ...
    if (ListsComparator::compareLists(list, currentNode->value) == 1)
    {
