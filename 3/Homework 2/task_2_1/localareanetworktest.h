...
/*!
 * \brief Класс для тестирования локальной сети
 * Тестирование производится на корректное создание локальной сети,
 * корректную последовательность заражения компьютеров (заражаться могут только соединённые с заражёнными).
 */
